...
class ReportOneAndroid extends Component {
  constructor() {
    super();
    this.state = {
      isOpen: false,
  ...
  render() {
    return (
      <React.Fragment>
        <PageHelmet pageTitle="Repeort One Android" />
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="rn-page-title text-center pt--100">
                  <h2 className="title theme-gradient">Report One Android</h2>
                </div>
              </div>
            </div>
          </div>
...
export default ReportOneAndroid;
